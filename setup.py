...
URL = "https://github.com/tped/ovos-skill-near-total-recall2"
SKILL_CLAZZ = "NearTotalRecallSkill"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-near-total-recall2"  # pip install PYPI_NAME
